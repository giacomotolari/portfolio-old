...
import Images from '../data/images/images.json'
...
<img id="logo" src={Images.logo} alt="logo"/>
    ...
    <nav className="navBar">
      ...
      {/* <button id="about-button"> */}
        <svg id="menu-icon" xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="currentColor" className="bi bi-list" viewBox="0 0 16 16">
  ...
  <div className="dropdown-menu">
    ...
    <a className="dropdown-item" href="#"></a>
      ...
      <div className="navBar-components">
        ...
        <svg id="home-icon" xmlns="http://www.w3.org/2000/svg" width="37" height="37" fill="currentColor" className="bi bi-house-door" viewBox="0 0 16 16">
          <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5z" />
        </svg>



        <button id="about-button" className="navLink">
          ABOUT
          </button>



        <button id="contact-button" className="navLink">
          CONTACT
            </button>


        <button id="portfolio-button" className="navLink">
          PORTFOLIO
            </button>
